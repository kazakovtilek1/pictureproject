      ...
      >
        ...
        <div className="block sm:hidden relative px-5 mt-30">
          ...
          <div className="absolute top-20 left-8 right-8 overflow-y-auto sm:overflow-visible bg-white p-4 rounded-2xl">
            ...
            <p className="my-4 text-xs font-normal">
              ...
              оставить свой след, заполнив элемент картины, став его соавтором.
            ...
            <p className="text-xs font-normal">
              Наша цель — показать силу единства через созидание. Проект
              объединяет людей разных возрастов и профессий в одном
              произведении, которое станет символом страны. В итоге мы создадим
              самую большую картину в истории Кыргызстана, оставив её как
        ...
        <div className="hidden sm:block max-w-[1180px] mx-auto mt-30 relative px-5 md:px-0">
          <Image
            ...
            height={650}
          />
          <div className="absolute -bottom-20 md:bottom-20 top-50 left-82 overflow-y-auto p-9 bg-white rounded-2xl">
