    ...
    >
      <div className="flex flex-col items-center gap-15 sm:items-center lg:flex lg:flex-row lg:items-start sm:justify-between">
        ...
        <div className="max-w-[580px] bg-[rgba(102,155,188,0.1)] backdrop-blur-3xl rounded-[20px] p-10 flex flex-col gap-10">
          ...
          />
          <button className="active:scale-95 active:brightness-50 uppercase text-white bg-[#780000] px-6 py-4 rounded-[10px] text-xs md:text-xl font-bold cursor-pointer hover:bg-[#E10D1D] active:bg-[#630000] transition-all ease-in-out duration-300">
            Принять участие
          </button>
        </div>
      </div>
